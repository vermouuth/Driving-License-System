...
namespace LicensesDataAccessLayer
{
    ...
    {
        public static bool GetPersonInfo(int PersonID, ref string FirstName, ref string SecondName,
        ...
        public static bool GetPersonInfoNational(string NationalNo, ref int PersonID, ref string FirstName, ref string SecondName,
